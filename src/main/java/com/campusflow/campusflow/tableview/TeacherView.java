...
public class TeacherView {
    ...
    public TeacherView(javafx.scene.control.TableView<Teacher> TeacherTable, javafx.scene.control.TableColumn<Teacher, Integer> tID, javafx.scene.control.TableColumn<Teacher, String> tName, javafx.scene.control.TableColumn<Teacher, String> tAddress, javafx.scene.control.TableColumn<Teacher, Long> tContact, javafx.scene.control.TableColumn<Teacher, String> tEmail, javafx.scene.control.TableColumn<Teacher, Integer> tFId, javafx.scene.control.TableColumn<Teacher, Integer> tSId) {
    ...
    public TeacherView(String search,javafx.scene.control.TableView<Teacher> TeacherTable, javafx.scene.control.TableColumn<Teacher, Integer> tID, javafx.scene.control.TableColumn<Teacher, String> tName, javafx.scene.control.TableColumn<Teacher, String> tAddress, javafx.scene.control.TableColumn<Teacher, Long> tContact, javafx.scene.control.TableColumn<Teacher, String> tEmail, javafx.scene.control.TableColumn<Teacher, Integer> tFId, javafx.scene.control.TableColumn<Teacher, Integer> tSId) {
        this.tableView = TeacherTable;
        this.tEmail= tEmail;
        this.tContact = tContact;
        this.tAddress= tAddress;
